...
const WishlistPage = () => {
  ...
  if (wishlistProducts.length === 0) {
    return (
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#111827] via-[#1f2937] to-[#4a1942]">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blush-500/20 via-tangerine-500/30 to-butter-500/20 animate-pulse"></div>
        ...
        <div className={`relative z-10 text-center px-4 max-w-lg transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="mb-8 inline-flex items-center justify-center w-32 h-32 bg-white/10 backdrop-blur-md rounded-full border border-white/20">
            <Heart className="h-16 w-16 text-blush-300" />
          </div>
          ...
          <button
            ...
            className="group px-10 py-4 bg-gradient-to-r from-blush-500 to-tangerine-500 text-white font-semibold rounded-full hover:shadow-2xl hover:shadow-blush-500/50 transition-all duration-300 transform hover:scale-105 hover:-translate-y-1"
          >
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="absolute top-20 right-10 w-96 h-96 bg-blush-500/5 rounded-full blur-3xl"></div>
      <div className="absolute bottom-40 left-10 w-80 h-80 bg-tangerine-500/5 rounded-full blur-3xl"></div>
      ...
      <section className={`relative container mx-auto px-4 pt-28 pb-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="mb-12 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-blush-100 rounded-full mb-4">
            <Heart className="w-4 h-4 text-blush-600 fill-blush-600" />
          ...
          {wishlistProducts.map((product, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden">
                ...
                >
                  <Heart className="h-5 w-5 fill-blush-500 text-blush-500" />
                </button>

                {/* Sale Badge */}
                {product.isSale && (
                  <div className="absolute top-4 left-4 px-3 py-1 bg-tangerine-500 text-white text-xs font-bold rounded-full shadow-lg">
                    SALE
                  </div>
                )}
              ...
              {/* Product Details */}
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2 text-gray-800 group-hover:text-blush-600 transition-colors line-clamp-1">
                  {product.name}
                </h3>
                  ...
                  {[...Array(5)].map((_, i) => (
                    <Star
                      ...
                      className={`h-4 w-4 ${i < Math.floor(product.rating)
                          ? 'fill-butter-400 text-butter-400'
                ...
                <div className="flex items-center space-x-2 mb-4">
                  <span className="text-xl font-bold bg-gradient-to-r from-blush-600 to-tangerine-600 bg-clip-text text-transparent">
                    ₹{product.price}
                  </span>
                ...
                <button
                  ...
                  className="w-full py-3 bg-gradient-to-r from-blush-500 to-tangerine-500 text-white font-semibold rounded-xl hover:shadow-xl hover:shadow-blush-500/30 transition-all duration-300 transform hover:scale-105"
                >
